...
#define GET_COLOR_RGB 21 // return value in GET.Color  INPUT: Index = Id of ColorRgb script command
...
#define GET_INVENTORY  24 // return values in GET.pInventory->  INPUT: none
...
#define FIND_LIGHT  3 // return values in FIND.VetLigths and FIND.TotLights  look for lights, fog bulbs and light effects
							// input: SlotType= D3D_ light type (or -1), RoomIndex = index of room (or -1)
...
#define NEW_SIZE_MEM_LIVELLO 0x3938700  // 60.000.0000 
